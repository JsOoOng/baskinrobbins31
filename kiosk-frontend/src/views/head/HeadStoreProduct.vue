<!--
  [화면 흐름 안내] HeadStoreProduct
  역할: 본사 관리에서 사용자가 보는 화면이다.
  진입: /head/store-products -> 이 Vue 파일 렌더링
  데이터: 사용자 동작 -> @/api/head/headStoreApi, @/api/head/headProductApi, @/api/head/headStoreProductApi -> 응답/상태 반영
