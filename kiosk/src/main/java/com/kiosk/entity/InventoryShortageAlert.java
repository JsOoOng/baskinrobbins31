...
/**
 * [코드 흐름 안내] InventoryShortageAlert
 *
 * <p>역할: 재고 데이터를 나타내는 JPA Entity다.</p>
 * <p>호출 흐름: Repository가 현재 코드의 inventory_shortage_alerts 테이블 매핑을 통해 이 객체를 저장·조회한다. 관계 키는 store_inventory_id, store_id, item_id를 사용한다.</p>
