...
nohup java -jar \
    -Dspring.datasource.url="jdbc:mysql://127.0.0.1:3308/kiosk?serverTimezone=Asia/Seoul&characterEncoding=UTF-8&useUnicode=true&useSSL=false&allowPublicKeyRetrieval=true" \
